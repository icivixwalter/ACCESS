Attribute VB_Name = "APPLICATION_Mdl03_CONTROLLO_TABLE_DB_ESTERNO"
...
'//------------------------------------------------------------------------------//
 ...
 '//DATABASE ESTERNO
 Set dbsNorthwind = OpenDatabase("c:\Casa\LINGUAGGI\ACCESS\PROGETTI_MDB\MSYS_OGGETTI\MDB\MENU_TB03_OGGETTI_DA_CANCELLARE\MENU_TB03_OGGETTI_DA_CANCELLARE.mdb")
