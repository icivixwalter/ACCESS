Attribute VB_Name = "CURRENTB_Mdl3_CANCELLA_QUERY_INTERNE_(da_finire)"
'//MODULO = "CURRENTB_Mdl3_CANCELLA_QUERY_INTERNE" _
    Cancella query nel db interno da sistemare.
    
    '//todo: CONTROLLARE PERCHE NON CANCELLA LE QUERY DEL DB CORRENTE.???
